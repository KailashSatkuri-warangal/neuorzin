...
export function AboutSection({ onOpenBooking }) {
  return (
    <div className="about-area inc-shape default-padding py-16 sm:py-24 bg-[#f8fafc]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          <div className="lg:col-span-6">
            <div className="thumb relative max-w-lg mx-auto lg:max-w-none">
          ...
          <div className="lg:col-span-6 info space-y-6 text-left">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              NeuOrzin bridges the gap between ambitious product roadmaps and robust, cloud-native implementation. We design resilient architectures that withstand hyper-scale growth while keeping infrastructure lean and cost-efficient.
            </p>
